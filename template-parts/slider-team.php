...
<div class="container"> <div class="row"><h2 class="secition-title">TEAM</h2></div></div>  <div class="row">
    <?php if(count($slides) > 0) { ?>
      <div id="teamCarousel" class="carousel slide carousel-fade" >
        <ol class="carousel-indicators-professionals">
        <?php $i=0; foreach($slides as $slide) { extract($slide); ?>
          <li data-target="#teamCarousel" data-slide-to="<?php echo $i ?>" <?php if($i==0) { ?>class="active"<?php } ?>>
        ...
        <div class="carousel-inner" role="listbox"> <!-- CARROUSEL INNER --> 
          <?php $i=0; foreach($slides as $slide) { extract($slide); ?>
            <div class="carousel-item  <?php if($i == 0) { ?>active<?php }; ?>" style="" >
